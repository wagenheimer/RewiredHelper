...
4. Assign `GameCursor` (an `Image` used as your custom cursor) and `CursorUIPointer` in the
   Inspector if your game uses a custom on-screen cursor. Both are optional.
